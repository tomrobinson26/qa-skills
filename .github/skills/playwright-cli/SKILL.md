...
* **Playwright Skills Workflow Guide** [references/workflow-guide.md](references/workflow-guide.md) — How to use playwright-cli, playwright-test-gen, and playwright-test-setup together
